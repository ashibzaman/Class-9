        ...
        <div class = "card-body">
         <form action="./controller/update.php" method= "POST">
          ...
          <div class="mb-3">
            ...
            <textarea name="details" class="form-control"><?=$post['details']?></textarea>
          ...
          <button type="submit" name = "submit" value="submitted" class="btn btn-primary w-100">Update</button>
        </form>
        </div>
    </div>
